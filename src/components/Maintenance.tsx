...
const Maintenance: React.FC = () => {
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="pt-28 md:pt-24 sm:pt-20">
        ...
        <div className="flex justify-center mt-8">
          <a
            ...
            className="px-6 py-3 border-2 border-blue-600 text-blue-600 rounded-full font-medium hover:bg-blue-600 hover:text-white shadow-sm transition-all"
          >
